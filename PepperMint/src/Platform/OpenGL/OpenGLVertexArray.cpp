...
void OpenGLVertexArray::addVertexBuffer(const std::shared_ptr<VertexBuffer>& iVertexBuffer) {
...
void OpenGLVertexArray::setIndexBuffer(const std::shared_ptr<IndexBuffer>& iIndexBuffer) {
	glBindVertexArray(_rendererId);
	iIndexBuffer->bind();
